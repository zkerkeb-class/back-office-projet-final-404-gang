    ...
    <header className="bg-indigo-600 text-white shadow-lg">
      <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <ul className="flex space-x-6">
          ...
          <li><Link to="/settings" className="hover:underline">Paramètres</Link></li>
          <li><Link to="/artists" className="hover:underline">Artistes</Link></li>
          <li><Link to="/albums" className="hover:underline">Albums</Link></li>
          <li><Link to="/tracks" className="hover:underline">Titres</Link></li>
          <li><Link to="/playlists" className="hover:underline">Playlists</Link></li>
          <li>
            {isLoggedIn ? (
              <button
